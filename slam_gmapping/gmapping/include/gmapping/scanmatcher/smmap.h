...
struct PointAccumulator{
	...
	*/
	/*after begin*/
	PointAccumulator(): acc(0,0), n(0), visits(0), change(0){}
	PointAccumulator(int i): acc(0,0), n(0), visits(0), change(0){assert(i==-1);}
	/*after end*/
	...
	inline void setDynamic(int value);
	inline int getDynamic();
};
...
void PointAccumulator::setDynamic(int value) {
		change = value;
}

int PointAccumulator::getDynamic() {
 	return change;
}
